...
<img src="static/images/welcomepage.png" width="100%" height="100%">
</div>
	<%--<div class="container-fluid" id="main-container">
			...
			<div id="page-content" class="clearfix">
				...
				&lt;%&ndash;<div class="page-header position-relative">&ndash;%&gt;
					&lt;%&ndash;<h1>&ndash;%&gt;
						&lt;%&ndash;后台首页 <small><i class="icon-double-angle-right"></i> </small>&ndash;%&gt;
					&lt;%&ndash;</h1>&ndash;%&gt;
				&lt;%&ndash;</div>&ndash;%&gt;
				<!--/page-header-->
				...
				&lt;%&ndash;<div class="row-fluid">&ndash;%&gt;
					...
					&lt;%&ndash;<div class="space-6"></div>&ndash;%&gt;
