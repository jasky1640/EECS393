		...
		<div id="zhongxin" style="margin: 15px 20px 0 20px">
			<table id="table_report" class="table table-striped table-bordered table-hover" >
				<c:if test="${pd.ROLE_ID != '1'}">
					...
					<td style="width:90px;text-align: right;padding-top: 13px;">等级:</td>
					<td>
					...
					<td style="width:90px;text-align: right;padding-top: 13px;">开通日期:</td>
					<td>
						<input class="span10" name="START_TIME" id="START_TIME" value="${pd.START_TIME}" type="text" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'});" readonly="readonly" placeholder="开通日期"  title="开通日期"/>
					</td>
				</tr>
				</c:if>
				<c:if test="${pd.ROLE_ID == '1'}">
				...
				<tr>
					...
					<td style="width:90px;text-align: right;padding-top: 13px;">到期日期:</td>
					<td>
						<input class="span10" name="END_TIME" id="END_TIME" value="${pd.END_TIME}" type="text" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'});" readonly="readonly" placeholder="到期日期" title="到期日期"/>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="email" name="EMAIL" id="EMAIL"  value="${pd.EMAIL }" maxlength="32" placeholder="这里输入邮箱" title="邮箱" onblur="hasE('${pd.USERNAME }')"/></td>
					</td>
				</tr>
				<tr>
					<td style="width:90px;text-align: right;padding-top: 13px;">密码:</td>
					<td style="vertical-align:top;">
						<input type="password" name="PASSWORD" id="password"  placeholder="输入密码"  title="密码"/>
					</td>
				...
				<tr>
					...
					<td>
						<input type="password" name="chkpwd" id="chkpwd"  placeholder="确认密码"  title="确认密码"/>
					</td>
					<td style="width:90px;text-align: right;padding-top: 13px;">身份证号:</td>
					<td style="vertical-align:top;">
						<input type="text" name="SFID" id="SFID" value="${pd.SFID }" placeholder="这里输入身份证号" title="身份证号" />
					</td>
				</tr>
				...
				<tr>
					...
					<td style="width:90px;text-align: right;padding-top: 13px;">开通年限:</td>
					<td>
						<input type="number" name="YEARS" id="YEARS" class="input_txt" value="${pd.YEARS }" placeholder="开通年限(请输入数字)" title="开通年限" />
					</td>
				</tr>
				<tr>
