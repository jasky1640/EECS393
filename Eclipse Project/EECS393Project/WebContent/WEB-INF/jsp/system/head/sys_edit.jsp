            ...
            <div class="tab-content">
			  <div id="home" class="tab-pane in active">
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					<tr>
						<td style="width:90px;text-align: right;padding-top: 13px;">系统名称:</td>
						<td><input type="text" name="YSYNAME" id="YSYNAME" value="${pd.YSYNAME }" placeholder="这里输入系统名称" style="width:90%" title="系统名称"/></td>
					
						<td style="width:90px;text-align: right;padding-top: 13px;">每页条数:</td>
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						<td style="width:90px;text-align: right;padding-top: 13px;">SMTP:</td>
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						<td style="width:90px;text-align: right;padding-top: 13px;">账号:</td>
			  ...
			  <div id="profile" class="tab-pane">
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td style="width:90px;text-align: right;padding-top: 13px;">字号:</td>
						<td><input type="number" name="fontSize" id="fontSize" value="${pd.fontSize }"  style="width:90%" title="字号"/></td>
					</tr>
					<tr>
						<td style="width:90px;text-align: right;padding-top: 13px;">X坐标:</td>
						<td><input type="number" name="fontX" id="fontX" value="${pd.fontX }"  style="width:90%" title="X坐标"/></td>
						<td style="width:90px;text-align: right;padding-top: 13px;">Y坐标:</td>
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						<td style="width:90px;text-align: right;padding-top: 13px;">水印:</td>
						<td colspan="10">
			  ...
			  <div id="profile3" class="tab-pane">
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					...
					<tr>
						<td style="width:90px;text-align: right;padding-top: 13px;">URL(服务器地址):</td>
					...
					<tr>
						<td style="width:90px;text-align: right;padding-top: 13px;">Token(令牌):</td>
