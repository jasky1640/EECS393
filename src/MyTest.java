...
public class MyTest {
    ...
    private ArrayList<Integer> normalRequirements;
    private ArrayList<Integer> requirementWithOneCourse;
    private Course courseWithPrerequisite;
    private ArrayList<Integer> coursesTaken1;
    private ArrayList<Integer> coursesTaken2;
    private ArrayList<Integer> coursesTaken3;
    private Plan fullPlan1, fullPlan2;
    private ArrayList<Plan> fullPlansList;
    ...
    public void checkPrerequisiteTest()
    {
        ...
        assertTrue(user.metPrerequisite(test1), "should return true");
    }
