...
<table bgcolor="#E3E4D8" width="100%">
	<tr>
		...
		<td width="100">
		<input type="text" id="suggestId" size="20" value="这里输入搜索地址" style="width:150px;" /></div><div id="monthoutResultPanel" style="border:1px solid #C0C0C0;width:150px;height:auto;">
		</td>
	</tr>
</table>
</div>
...
var str = "";
    ...
    //G("monthoutResultPanel").innerHTML = str;
});
...
var _value = e.item.value;
   ...
   //G("monthoutResultPanel").innerHTML ="onconfirm<br />index = " + e.item.index + "<br />myValue = " + myValue;
...
function setPlace(){
    ...
    var local = new BMap.LocalMonthout(map, { //智能搜索
      onMonthoutComplete: myFun
    });
    local.monthout(myValue);
}
